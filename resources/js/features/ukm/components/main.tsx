...
const UkmMain = () => {
    ...
    return (
      <>
        <img
          ...
          alt="orname"
          className="absolute left-0 -top-24 -scale-x-100 w-1/3"
        />
        <img
          src="/assets/fragments/ukm-background-4.svg"
          alt="orname"
          className="absolute right-0 -top-24 w-1/3"
        />
        <img
          src="/assets/fragments/ukm-background.svg"
          alt="orname"
          className="absolute left-0 bottom-0 -scale-x-100 w-1/3"
        />
        <img
          src="/assets/fragments/ukm-background.svg"
          alt="orname"
  ...
  return (
    <section className="min-h-screen h-[200vh] relative w-full">
      <BgOrnamen />
