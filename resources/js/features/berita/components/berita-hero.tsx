  ...
  return (
    <div className="h-screen w-full relative flex-col my-10 lg:my-30 top-0 flex items-center ">
      <div className="w-full h-full z-20">
        <div className="w-full min-h-24 batik-head-atas -mb-6 relative scale-y-[-1] " />
        ...
        <div className="w-full min-h-24 batik-head-atas -mt-6 " />
      </div>
